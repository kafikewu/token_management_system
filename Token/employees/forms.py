...
class ProcessTokenForm(forms.Form):
    approval = forms.ChoiceField(choices=((1, "Yes"), (2, "No")), widget=forms.Select(attrs={
        "class": "form-control dropdown"
    }))
    state_of_emergency = forms.ChoiceField(choices=((1, "Yes"), (2, "No")), widget=forms.Select(attrs={
        "class": "form-control dropdown"
    }))
    ...
    def __init__(self, body):
        ...
        for field_name in body:
            ...
            if field_type == "text":
                self.fields[field_name] = forms.CharField(required=False, label=field_name.replace('_', ' ').title(),
